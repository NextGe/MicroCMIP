define(['jquery', 'common', "handlebars.min", "text!../../Monitor/handlebars/task.html"], function ($, common, Handlebars, html_template) {
    ...
    function show_page(menuId, urls, templates) {
        show_common(menuId, "mnodeconfig/GetTaskList",urls,templates, function () {
