...
namespace EFWCoreLib.WcfFrame.SDMessageHeader
{
    ...
    public class HeaderOperater
    {
        ...
        public static void AddMessageHeader(Message requestMessage, HeaderParameter para)
        {
            ...
            requestMessage.Headers.RemoveAll("NodePath", ns);
            ...
            var NodePath = System.ServiceModel.Channels.MessageHeader.CreateHeader("NodePath", ns, para.NodePath);
            requestMessage.Headers.Add(NodePath);
        }
        ...
        public static HeaderParameter GetHeaderValue(Message requestMessage)
        {
            ...
            index = headers.FindHeader("NodePath", ns);
            if (index > -1)
                para.NodePath = headers.GetHeader<MNodePath>(index);
            return para;
        }
    }
}
