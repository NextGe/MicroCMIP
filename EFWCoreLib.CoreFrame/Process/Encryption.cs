...
{
    public class MNodeRegCode
    {
        public static string CreateRegCode(string identify,string machinecode,string regdate)
        {
           return  Encryption.EncryPW(CreatSerialNumber(identify,machinecode,regdate), "kakake888");
        }
