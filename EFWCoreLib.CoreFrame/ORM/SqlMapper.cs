...
#pragma warning restore 618
        ...
        {
            return Query<T>(cnn,null, sql, param, null, true, null, null);
        }
        ...
        {
            return Query<T>(cnn,null, sql, param, transaction, true, null, null);
        }
        ...
        {
            return Query<T>(cnn,null, sql, param, null, true, null, commandType);
        }
        ...
        {
            return Query<T>(cnn,null ,sql, param, transaction, true, null, commandType);
        }
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        public static IEnumerable<dynamic> Query(this IDbConnection cnn, string pluginname, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null)
        {
            return Query<DapperRow>(cnn, pluginname, sql, param as object, transaction, buffered, commandTimeout, commandType);
        }
#else
        /// <summary>
        /// Return a list of dynamic objects, reader is closed after the call
        ...
        {
            return Query<IDictionary<string, object>>(cnn,null, sql, param, transaction, buffered, commandTimeout, commandType);
        }
#endif
...
#if CSHARP30
this IDbConnection cnn, string pluginname,string sql, object param, IDbTransaction transaction, bool buffered, int? commandTimeout, CommandType? commandType
#else
this IDbConnection cnn, string pluginname, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
#endif
)
        {
            ...
            var data = QueryImpl<T>(cnn,pluginname, command, typeof(T));
...
this IDbConnection cnn, Type type, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
        ...
        )
        {
            if (type == null) throw new ArgumentNullException("type");
            var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
            var data = QueryImpl<object>(cnn,null, command, type);
            return command.Buffered ? data.ToList() : data;
        }
        /// <summary>
        /// Executes a query, returning the data typed as per T
        ...
        {
            var data = QueryImpl<T>(cnn,null, command, typeof(T));
            return command.Buffered ? data.ToList() : data;
        }
...
this IDbConnection cnn, string sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType
        ...
        private static IEnumerable<T> QueryImpl<T>(this IDbConnection cnn, string pluginname, CommandDefinition command, Type effectiveType)
        {
            object param = command.Parameters;
...
#if CSHARP30
this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TReturn> map, object param, IDbTransaction transaction, bool buffered, string splitOn, int? commandTimeout, CommandType? commandType
#else
this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
#endif
)
        {
            return MultiMap<TFirst, TSecond, DontMap, DontMap, DontMap, DontMap, DontMap, TReturn>(cnn,pluginname, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
...
#if CSHARP30
this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TReturn> map, object param, IDbTransaction transaction, bool buffered, string splitOn, int? commandTimeout, CommandType? commandType
#else
this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
#endif
)
        {
            return MultiMap<TFirst, TSecond, TThird, DontMap, DontMap, DontMap, DontMap, TReturn>(cnn, pluginname,sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
...
#if CSHARP30
this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param, IDbTransaction transaction, bool buffered, string splitOn, int? commandTimeout, CommandType? commandType
#else
this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
#endif
)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, DontMap, DontMap, DontMap, TReturn>(cnn,pluginname, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(
            this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, DontMap, DontMap, TReturn>(cnn,pluginname, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(
            this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, DontMap, TReturn>(cnn,pluginname, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(this IDbConnection cnn, string pluginname, string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(cnn, pluginname, sql, map, param as object, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        static IEnumerable<TReturn> MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
            this IDbConnection cnn, string pluginname, string sql, Delegate map, object param, IDbTransaction transaction, bool buffered, string splitOn, int? commandTimeout, CommandType? commandType)
        {
            var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
            ...
            //给实体绑定插件数据
            if (results is EFWCoreLib.CoreFrame.Business.AbstractEntity)
            {
                EFWCoreLib.CoreFrame.Plugin.ModulePlugin mp = EFWCoreLib.CoreFrame.Init.AppPluginManage.PluginDic[pluginname];
                if (mp != null)
                    (results as EFWCoreLib.CoreFrame.Business.AbstractEntity).BindDb(mp.database, mp.container, mp.cache, mp.plugin.name);
            }
...
#pragma warning restore 612, 618
    ...
    sealed partial class DefaultTypeMap : SqlMapper.ITypeMap
    {
        ...
        {
            //if (columnName.ToLower() == "workid") return null;

            if (_type.GetCustomAttributes(false).OfType<TableAttribute>().Count() > 0)//实体配置了自定义标签
            {
                var property = _properties.FirstOrDefault(p => (p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault()!=null && string.Equals(p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault().FieldName, columnName, StringComparison.Ordinal)))
                  ?? _properties.FirstOrDefault(p => (p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault() != null && string.Equals(p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault().FieldName, columnName, StringComparison.OrdinalIgnoreCase)));

                if (property == null && MatchNamesWithUnderscores)
                {
                    property = _properties.FirstOrDefault(p => string.Equals(p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault().FieldName, columnName.Replace("_", ""), StringComparison.Ordinal))
                        ?? _properties.FirstOrDefault(p => string.Equals(p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault().FieldName, columnName.Replace("_", ""), StringComparison.OrdinalIgnoreCase));
                }
